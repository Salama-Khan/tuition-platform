...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Tuition Platform API',
    'DESCRIPTION': 'Minimal API for subjects and onboarding',
    'VERSION': '1.0.0',
}
...
AWS_STORAGE_BUCKET_NAME = 'epl-tutors-media-assets-2025'
...
# 2. TELL DJANGO TO USE THAT DOMAIN FOR LINKS
STATIC_URL = f'https://{AWS_S3_CUSTOM_DOMAIN}/static/'
MEDIA_URL = f'https://{AWS_S3_CUSTOM_DOMAIN}/media/'

# 3. TELL DJANGO TO STORE FILES THERE
STORAGES = {
    "default": {
